...
address('fake_identities_vector',globals,'world','assumed_identities','all')
...
address('fake_name',df.assumed_identity,'name')
address('fake_birth_year',df.assumed_identity,'birth_year')
address('fake_birth_time',df.assumed_identity,'birth_second')
...
--address('layer_status_vector',df.body_component_info,'body_layer_338')
...
--address('cie_phys',df.creature_interaction_effect_phys_att_changest,'phys_att_unk')
--address('cie_ment',df.creature_interaction_effect_ment_att_changest,'ment_att_unk')
...
address('traits',df.unit_soul,'traits')
